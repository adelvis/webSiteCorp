...
<div class="container-fluid" style="background:#efebe9">
	...
	<section id="contact">
			...
			<div class="container py-5">
					    ...
					    <!--Section heading-->
					    <h2 class="h2-responsive font-weight-bold text-center my-4 orange-text">Contactenos</h2>
					    <!--Section description-->
					        ...
					        <div class="col-md-3 text-center grey-text">
					            <ul class="list-unstyled mb-0">
					                <li><i class="fas fa-map-marker-alt fa-2x"></i>
					                    <p>Distrito Capital, CA 1000, Venezuela</p>
					                </li>

					                <li><i class="fas fa-phone mt-4 fa-2x"></i>
					                    <p>(+58) 414-252-94-92</p>
					                </li>

					                <li><i class="fas fa-envelope mt-4 fa-2x"></i>
					                    <p>TPS.Corporation.inc@gmail.com</p>
					                </li>

					                <li><i class="fas fa-building mt-4 fa-2x"></i>
					                    <p>Lun - Vier, 8:00-22:00</p>
					                </li>
					            </ul>
					        </div>
					        <!--Grid column-->
